"""Versioning and audit history for Approval Engine."""
...
class ApprovalHistory(FortiBaseModel):
    """Version snapshot of an ApprovalRequest."""
    ...
    snapshot: ApprovalRequest = Field(...)
...
class ApprovalAuditRecord(FortiBaseModel):
    id: UUID = Field(default_factory=new_id)
